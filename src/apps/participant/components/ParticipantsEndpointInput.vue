    ...
    <div>
      <div class="text-center">
        ...
        <p class="mt-2 text-sm font-light text-gray-400">
          By loading a valid "participants API endpoint", we can display all
          relevant information for Open Banking Brasil participants registered
          in the Raidiam directory platform.
        </p>
      </div>
      <div class="mt-6 flex">
